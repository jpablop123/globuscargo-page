...
export default function CotizarEnvioPage() {
  ...
  return (
    <main className={`${montserrat.className} bg-gradient-to-b from-[#fff9f5] via-[#fff6f1] to-white text-[#333] min-h-screen relative`}>
      <Header />

      {/* === HERO === */}
      <section className="relative text-white pt-36 md:pt-44 pb-28 px-6 text-center overflow-hidden bg-gradient-to-r from-[#f58220] to-[#ff9b42]">
        <Image
          src={globusLogo}
          alt="Globus Cargo"
          width={180}
          height={180}
          className="mx-auto mb-4 drop-shadow-md opacity-90"
        />
        <motion.h1
        ...
        <p className="text-base md:text-lg text-white/90 max-w-2xl mx-auto leading-relaxed">
          Calcula en segundos el costo estimado de tu envío desde EE. UU. hacia cualquier ciudad de Colombia 🇨🇴
        </p>
        <p className="mt-3 text-sm text-white/80 italic">
          Sin tarifas ocultas, sin complicaciones.
        </p>
      </section>
        ...
        <AnimatePresence mode="wait">
          {!showResult ? (
            <motion.form
              ...
              className="bg-white/75 backdrop-blur-xl border border-white/40 p-8 md:p-10 rounded-3xl shadow-[0_8px_40px_-12px_rgba(245,130,32,0.25)] relative"
            >
              <Image
                src={globusLogo}
                alt="Globus Cargo"
              ...
              <div className="grid sm:grid-cols-2 gap-6">
                ...
                {/* Peso */}
                <motion.div
                  animate={shakeField === "peso" ? { x: [-6, 6, -6, 6, 0] } : { x: 0 }}
                ...
                {/* Valor declarado */}
                <motion.div
                  animate={shakeField === "valor" ? { x: [-6, 6, -6, 6, 0] } : { x: 0 }}
                  transition={{ duration: 0.4 }}
                >
                  <label className="block text-sm font-medium text-gray-600 mb-2">
            ...
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.5 }}
              className="text-center bg-white/75 backdrop-blur-xl border border-white/40 p-8 md:p-10 rounded-3xl shadow-[0_8px_40px_-12px_rgba(245,130,32,0.25)] relative"
            >
              <FaCheckCircle className="text-[#f58220] text-5xl mx-auto mb-3 animate-bounce" />
              <h3 className="text-2xl font-bold text-[#f58220] mb-4">Cotización generada con éxito</h3>
              ...
              <p className="text-gray-600 mb-5 italic">
                Tu envío está a un clic de distancia 
              </p>
            ...
            {showLegal && (
              ...
              >
                <p>
                  ...
                  y pueden variar según el peso volumétrico, tipo de producto y destino final.
                </p>
                <p>
                ...
                <p>
                  Globus Cargo no se hace responsable por diferencias de costos generadas por cambios en tarifas o impuestos.
                </p>
                <p>
                  Esta cotización no constituye una factura final, sino una guía informativa basada en los datos ingresados.
                </p>
              </motion.div>
            )}
          </AnimatePresence>
